...
En el Perú, la siniestralidad vial constituye un desafío estructural para las instituciones encargadas de la regulación, supervisión y gestión del tránsito. A los factores comunes en el ámbito internacional se suman elementos propios del contexto nacional: la informalidad en el transporte, la diversidad geográfica del territorio y las marcadas diferencias entre entornos urbanos y rurales. De acuerdo con el Ministerio de Transportes y Comunicaciones (MTC, 2024), la imprudencia del conductor y el exceso de velocidad figuran entre las principales causas de siniestros viales a nivel nacional.
Esta complejidad se manifiesta también en los distintos contextos territoriales. En las zonas urbanas, la alta concentración vehicular expone permanentemente a peatones, motociclistas y pasajeros; mientras que en las carreteras interprovinciales y vías rurales predominan los riesgos asociados a velocidades elevadas, condiciones climáticas adversas, infraestructura precaria y menor capacidad de respuesta ante emergencias. Esta heterogeneidad territorial refuerza la necesidad de contar con información integrada que permita analizar los siniestros desde perspectivas geográficas, temporales y descriptivas de manera simultánea.
Para responder a esta necesidad, el Observatorio Nacional de Seguridad Vial (ONSV) del Ministerio de Transportes y Comunicaciones cumple un rol central en la recopilación, sistematización y difusión de información sobre riesgos, causas y consecuencias de los siniestros viales. A través de su portal de datos abiertos, el ONSV pone a disposición información sobre siniestros de tránsito fatales, personas involucradas y vehículos a nivel nacional durante el período 2021–2025, constituyendo una fuente valiosa para investigadores, instituciones públicas y tomadores de decisiones.

# 2. Problemática
A pesar de la disponibilidad de estos registros, su mera existencia no garantiza su utilidad analítica. La información del ONSV se encuentra distribuida en diferentes archivos y estructuras de almacenamiento, con distintos formatos y niveles de calidad, lo que dificulta su integración y procesamiento conjunto. Esta dispersión impide identificar de manera eficiente los patrones, tendencias y factores asociados a la ocurrencia de siniestros, limitando la capacidad institucional de generar conocimiento orientado a la toma de decisiones basada en evidencia.
En otras palabras, existe una brecha concreta entre la disponibilidad de los datos y su efectivo aprovechamiento: los registros existen, pero no están organizados en una estructura que permita responder preguntas analíticas de forma oportuna y confiable. La ausencia de un modelo integrado de información impide explorar simultáneamente las dimensiones territoriales, temporales y descriptivas de la siniestralidad vial fatal, restringiendo la capacidad de las autoridades para diseñar intervenciones focalizadas y evaluar su impacto.
Esta situación evidencia la necesidad de construir una solución que transforme los datos públicos disponibles en información estructurada y accionable, que sirva de base para el análisis, la visualización y la toma de decisiones en materia de seguridad vial.
